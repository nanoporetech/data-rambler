...
import { parse_add_expression, parse_assignment_expression, parse_call_expression, parse_chain_expression, parse_coalescing_expression, parse_comma_expression, parse_computed_property_expression, parse_conditional_expression, parse_divide_expression, parse_equals_expression, parse_exponentiation_expression, parse_function_expression, parse_greater_than_expression, parse_greater_than_or_equals_expression, parse_less_than_expression, parse_less_than_or_equals_expression, parse_logical_and_expression, parse_logical_in_expression, parse_logical_or_expression, parse_multiply_expression, parse_not_equals_expression, parse_property_expression, parse_range_expression, parse_remainder_expression, parse_subtract_expression, parse_wild_expression } from './expressions/infix';
import { parse_array_literal, parse_boolean_literal, parse_group_expression, parse_identifier_literal, parse_negation_expression, parse_not_expression, parse_null_literal, parse_number_literal, parse_object_literal, parse_plus_expression, parse_string_literal, parse_typeof_expression, parse_undefined_literal } from './expressions/prefix';
...
add_prefix_parselet('symbol:+',             10, parse_plus_expression);
...
add_infix_parselet ('symbol:.',             11, parse_property_expression);
add_infix_parselet ('symbol:.*',            11, parse_wild_expression);
add_infix_parselet ('symbol:[',             11, parse_computed_property_expression);

add_infix_parselet ('symbol:|>',		        12, parse_chain_expression);
add_infix_parselet ('symbol:=>',            12, parse_function_expression);
...
add_prefix_parselet('identifier:undefined', 14, parse_undefined_literal);
add_prefix_parselet('identifier',           14, parse_identifier_literal);
